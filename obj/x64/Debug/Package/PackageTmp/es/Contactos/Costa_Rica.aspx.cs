...
{
    public partial class Costa_Rica : System.Web.UI.Page
    {
        ...
        public void CargaInfo(Int32 paramIDContacto, Int32 paramTipoContacto)
        {
            ...
            try
            {
                using (OracleConnection cnn = objCnn.getConection())
                {
                    try
                    {
                        ...
                        cmd.CommandText = "iddba.web16.GetInfoContactosEspecifico";
                        cmd.Connection = cnn;
                        cmd.Parameters.Add("paramIDContacto", OracleDbType.Int32, ParameterDirection.Input);
                        cmd.Parameters["paramIDContacto"].Value = paramIDContacto;
        ...
        public void ingresaFila(string[] directorio)
        {
            ...
            celdaTres.Text = UT.rellenaDiv(directorio, 12, 17);
