...
{
    public partial class Offset_hoja_heatset_periodicos : System.Web.UI.Page
    {
            ...
            try
            {
                using (OracleConnection cnn = objCnn.getConection())
                {
                    try
                    {
                        ...
                        celda1.Text = "Offset hoja, heatset y periódicos";
                        ...
                        {
                            /*
                            divContactos.InnerHtml = "<h2>Offset hoja, heatset y periódicos</h2>";
                            while (rdr.Read())
                            {
                                strHTMLInfoContacto = "<table>" +
                                    "<tr><td class='Contactos_Alias'>" + rdr["alias"].ToString() + "</td></tr>" +
                                    "<tr><td>" + rdr["nombre_puesto"].ToString() + "</td></tr>" +
                                    "<tr><td><a href=\"mailto:" + rdr["email"].ToString() + "\" target=\"_top\">" + rdr["email"].ToString() + "</a></td></tr>" +
                                    /*"<tr><td>" + rdr["telefono"].ToString() + "</td></tr>" +
                                    "<tr><td>" + rdr["dir1"].ToString() + "</td></tr>" +
                                    "<tr><td>" + rdr["dir2"].ToString() + "</td></tr>" +*
                                    "</table>";

                                divContactos.InnerHtml = divContactos.InnerHtml + strHTMLInfoContacto;
                            }
                             * */
                            ///////////////////////////////////////////////////////////////////////////////////////////
        ...
        public void ingresaFila(string[] directorio)
        {
